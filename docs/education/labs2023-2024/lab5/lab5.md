...
Правила по оформлению отчета по лабораторной работе вы можете изучить по [ссылке](../reportdesign.md). В качестве формы отчета нужно также представить запись экрана и прикрепить ссылку на нее в файле отчета.
